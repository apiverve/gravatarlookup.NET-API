...
namespace APIVerve
{
    public class GravatarLookupAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/gravatarlookup";
        ...
        public GravatarLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public GravatarLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, gravatarlookupQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(gravatarlookupQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(gravatarlookupQueryOptions options)
        {
